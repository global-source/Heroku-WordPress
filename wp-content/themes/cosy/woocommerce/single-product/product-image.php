...
$enable_zoom    = ( Cosy()->settings->get('single_product_zoom', 'off') == 'on' ) ? 1 : 0;
$zoom_type      = Cosy()->settings->get('single_product_zoom_type', 'inner');
$enable_popup    = ( Cosy()->settings->get('product_popup', 'off') == 'on' ) ? 1 : 0;
