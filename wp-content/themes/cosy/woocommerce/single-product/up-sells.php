...
if ( $upsells ) : ?>
    ...
    $product_cols = shortcode_atts(
        ...
        Cosy()->settings->get('upsell_products_columns')
    );
    ...
    <div class="related-wrap">
        <div class="up-sells upsells related-product">
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="related-product--title text-center"><?php esc_html_e( 'You may also like&hellip;', 'cosy' ); ?></h3>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12">
