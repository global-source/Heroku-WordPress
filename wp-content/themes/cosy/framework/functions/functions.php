...
if(!function_exists('cosy_entry_meta_item_postdate')){
    function cosy_entry_meta_item_postdate(){
        ...
        printf(
            '<span class="posted-on"><a href="%1$s" rel="bookmark"><i class="fa-calendar-o"></i><span class="screen-reader-text">%2$s </span>%3$s</a></span>',
            esc_url( get_permalink() ),
            esc_html__('Posted on', 'cosy'),
            $time_string
        );
    }
}
if(!function_exists('cosy_entry_meta_item_author')){
    function cosy_entry_meta_item_author(){
        printf(
...
if(!function_exists('cosy_entry_meta_item_category_list')){
    function cosy_entry_meta_item_category_list($separator = ', ', $parents = ''){
        $categories_list = get_the_category_list('{{_}}', $parents);
        if ( $categories_list ) {
            printf(
                '<div class="cat-links"><span class="screen-reader-text">%1$s </span><span>%2$s</span></div>',
                esc_html__('Posted in', 'cosy'),
...
if(!function_exists('cosy_entry_meta_item_comment_post_link')){
    function cosy_entry_meta_item_comment_post_link(){
...
if(!function_exists('cosy_entry_meta_item_post_love')) {
    function cosy_entry_meta_item_post_love()
    {
...
if(!function_exists('cosy_entry_meta')){
    function cosy_entry_meta(){
        echo '<div class="pull-left">';
        cosy_entry_meta_item_postdate();
        cosy_entry_meta_item_author();
        cosy_entry_meta_item_category_list();
        echo '</div>';
        echo '<div class="pull-right">';
        cosy_entry_meta_item_comment_post_link();
        cosy_entry_meta_item_post_love();
        echo '</div>';
    }
}

if(!function_exists('cosy_single_post_thumbnail')){
    function cosy_single_post_thumbnail( $thumbnail_size = 'full'){
...
if(!function_exists('cosy_social_sharing')){
    function cosy_social_sharing( $post_link = '', $post_title = '', $image = '', $echo = true){
        ...
        if(Cosy()->settings->get('sharing_facebook') || 'on' == Cosy()->settings->get('sharing_facebook')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="facebook" title="%2$s"><i class="fa fa-facebook"></i></a>',
                ...
                esc_attr__('Share this post on Facebook', 'cosy')
            );
        }
        if(Cosy()->settings->get('sharing_twitter') || 'on' == Cosy()->settings->get('sharing_twitter')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="twitter" title="%2$s"><i class="fa fa-twitter"></i></a>',
                ...
                esc_attr__('Share this post on Twitter', 'cosy')
            );
        }
        if(Cosy()->settings->get('sharing_reddit') || 'on' == Cosy()->settings->get('sharing_reddit')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="reddit" title="%2$s"><i class="fa fa-reddit"></i></a>',
                ...
                esc_attr__('Share this post on Reddit', 'cosy')
            );
        }
        if(Cosy()->settings->get('sharing_linkedin') || 'on' == Cosy()->settings->get('sharing_linkedin')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="linkedin" title="%2$s"><i class="fa fa-linkedin"></i></a>',
                ...
                esc_attr__('Share this post on Linked In', 'cosy')
            );
        }
        if(Cosy()->settings->get('sharing_google_plus') || 'on' == Cosy()->settings->get('sharing_google_plus')){
            printf('<a href="%1$s" rel="nofollow" class="google-plus" title="%2$s"><i class="fa fa-google-plus"></i></a>',
                ...
                esc_attr__('Share this post on Google Plus', 'cosy')
            );
        }
        if(Cosy()->settings->get('sharing_tumblr') || 'on' == Cosy()->settings->get('sharing_tumblr')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="tumblr" title="%2$s"><i class="fa fa-tumblr"></i></a>',
                ...
                esc_attr__('Share this post on Tumblr', 'cosy')
            );
        }
        if(Cosy()->settings->get('sharing_pinterest') || 'on' == Cosy()->settings->get('sharing_pinterest')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="pinterest" title="%2$s"><i class="fa fa-pinterest-p"></i></a>',
                ...
                esc_attr__('Share this post on Pinterest', 'cosy')
            );
        }
        if(Cosy()->settings->get('sharing_whatsapp') || 'on' == Cosy()->settings->get('sharing_whatsapp')){
            printf('<a href="%1$s" rel="nofollow" class="pinterest" title="%2$s"><i class="fa fa-whatsapp"></i></a>',
                'whatsapp://send?text=' . esc_attr(  $post_title. ' - ' . $post_link ) ,
                esc_attr__('Share this post on WhatsApp', 'cosy')
            );
        }
        if(Cosy()->settings->get('sharing_vk') || 'on' == Cosy()->settings->get('sharing_vk')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="vk" title="%2$s"><i class="fa fa-vk"></i></a>',
                ...
                esc_attr__('Share this post on VK', 'cosy')
            );
        }
        if(Cosy()->settings->get('sharing_email') || 'on' == Cosy()->settings->get('sharing_email')){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="email" title="%2$s"><i class="fa fa-envelope"></i></a>',
                ...
                esc_attr__('Share this post via Email', 'cosy')
            );
        }
        echo '</div>';
        if(!$echo){
...
if(!function_exists('cosy_the_pagination')){
    function cosy_the_pagination($args = array(), $query = null) {
        if(null === $query) {
        ...
        printf('<div class="la-pagination">%s</div>',
            paginate_links(array_merge(array(
                ...
                'prev_text'    => esc_html__('Prev', 'cosy'),
                'next_text'    => esc_html__('Next', 'cosy'),
                'type'         => 'list'
            ), $args))
        );
    }
...
if(!function_exists('cosy_get_social_media')){
    function cosy_get_social_media( $style = 'default', $el_class = ''){
        ...
        $social_links = Cosy()->settings->get('social_links', array());
...
if(!function_exists('cosy_get_portfolio_social_media')){
    function cosy_get_portfolio_social_media($post_id = 0, $el_class = ''){

        $css_class = 'social--sharing ' . $el_class;

        $social_links = Cosy()->settings->get_post_meta($post_id,'social_links');
...
if(!function_exists('cosy_comment_form_callback')) {
    function cosy_comment_form_callback($comment, $args, $depth){
        ...
        switch ($comment->comment_type) :
            ...
            case 'trackback' :
                ...
                <p class="cmt-pingback"><?php esc_html_e('Pingback:', 'cosy'); ?><?php comment_author_link(); ?><?php edit_comment_link(esc_html__('Edit', 'cosy'), '<span class="ping-meta"><span class="edit-link">', '</span></span>'); ?></p>
                <?php
                break;
            default :
                    ...
                    <div class="comment-text">
                        ...
                        <div class="comment-meta">
                            ...
                            printf('<time datetime="%1$s">%2$s</time>',
                                get_comment_time('c'),
                                sprintf(esc_html_x('%1$s', '1: date', 'cosy'), get_comment_date())
                            );
                            edit_comment_link(esc_html__('Edit', 'cosy'), ' <span class="edit-link">', '</span>'); ?>
                            <?php if ('0' == $comment->comment_approved) : ?>
                                <em class="comment-awaiting-moderation"><?php esc_html_e('Your comment is awaiting moderation.', 'cosy'); ?></em>
                            <?php endif; ?>
