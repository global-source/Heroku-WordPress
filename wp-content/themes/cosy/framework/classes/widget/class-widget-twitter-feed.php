...
class Cosy_Widget_Twitter_Feed extends WP_Widget {

    public function __construct(){
        parent::__construct(
            'twitter_feed',
            esc_html__('Cosy Twitter Feed', 'cosy'),
            array(
                'description' => esc_html__('Display Twitter Feed', 'cosy')
            )
        );
    }
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_attr_e( 'Title:', 'cosy' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'screen_name' ) ); ?>"><?php esc_attr_e( 'Screen Name:', 'cosy' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_attr_e( 'Number Feed:', 'cosy' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'enable_slider' ) ); ?>"><?php esc_attr_e( 'Enable Slider:', 'cosy' ); ?></label>
        </p>
        <?php
    }
