...
class Cosy_Template{
    ...
    public function body_classes( $classes ) {
        ...
        $page_title_bar_layout      = Cosy()->layout->get_page_title_bar_layout();

        $main_fullwidth             = Cosy()->settings->get_setting_by_context('main_full_width','no');
        $header_full_width          = Cosy()->settings->get_setting_by_context('header_full_width', 'no');
        $header_transparency        = Cosy()->settings->get_setting_by_context('header_transparency', 'no');

        $footer_full_width          = Cosy()->settings->get_setting_by_context('footer_full_width','no');
        ...
        if($header_layout != 4 && $header_layout != 5){
