 ...
 * @return array
 */
function cosy_metaboxes_section_footer( $sections )
{
    $sections['footer'] = array(
        ...
        'fields'    => array(
            array(
                ...
                'title'         => esc_html__('Hide Footer', 'cosy'),
            ...
            array(
                ...
                'desc'          => esc_html__('Controls the layout of the footer.', 'cosy'),
                'default'       => 'inherit',
                'options'       => Cosy_Options::get_config_footer_layout_opts(false, true),
            ...
            array(
                ...
                'default'       => 'inherit',
                'class'         => 'la-radio-style',
                'title'         => esc_html__('SHOW Footer Copyright', 'cosy'),
                'options'       => Cosy_Options::get_config_radio_opts()
            )
        )
    );
