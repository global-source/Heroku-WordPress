<?php
$show_cart      = (Cosy_Helper::is_active_woocommerce() && (Cosy()->settings->get('header_show_cart', 'no') == 'yes')) ? true : false;
$show_search    = (Cosy()->settings->get('header_show_search', 'no') == 'yes') ? true : false;
?>
                ...
                <div class="header-left">
                    <div class="site-branding">
                        <a href="<?php echo esc_url( home_url( '/'  ) ); ?>" rel="home">
                            <figure><?php Cosy()->layout->render_mobile_logo();?></figure>
                        </a>
                    </div>
                </div>
