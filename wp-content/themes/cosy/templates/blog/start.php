...
global $wp_query, $wp_rewrite, $cosy_loop;

$blog_design = Cosy()->settings->get('blog_design', 'grid_1');
$blog_columns = wp_parse_args( (array) Cosy()->settings->get('blog_post_column'), array('lg'=> 1,'md'=> 1,'sm'=> 1,'xs'=> 1, 'mb' => 1) );
$blog_masonry = ( Cosy()->settings->get('blog_masonry') == 'on' ) ? true : false;
$blog_pagination_type = Cosy()->settings->get('blog_pagination_type', 'pagination');
...
$cosy_loop['blog_design'] = $blog_design;
?>
<div
